...
AddEventHandler('esx:sendMessage', function(source, args)
	...
	if #args >= 2 or not xPlayerTarget then
		...
		xPlayer.sendChatMessage("ID de joueur incorrect !", "FiveLife", {255, 0, 0})
	end
end)
	...
	if args[1] or not GetPlayerName(tonumber(args[1]))then
		...
		for _,anyXPlayer in pairs(ESX.GetAllPlayers()) do
			if IsPlayerAceAllowed(anyXPlayer.source, 'command') then
				anyXPlayer.sendChatMessage("^2" .. xPlayerTarget.getName() .. "^0 a été kick par ^2" .. xPlayer.getName() .. "^0 (^2" .. reason .. "^0)", "FiveLife", {255, 0, 0})
			end
		end
...
ESX.RegisterCommand('bring', 'mod', function(xPlayer, args, showError)
	...
	TriggerClientEvent('chatMessage', args.playerId.source, "FiveLife", {255, 0, 0}, "Vous avez teleporté par ^2" .. xPlayer.getName())
	TriggerClientEvent('chatMessage', xPlayer.source, "FiveLife", {255, 0, 0}, "Player ^2" .. args.playerId.getName() .. "^0 a été teleporté")
...
ESX.RegisterCommand({'bringall', 'tpall'}, 'superadmin', function(xPlayer, args, showError)
	for _,anyXPlayer in pairs(ESX.GetAllPlayers()) do
		if anyXPlayer ~= xPlayer then
			...
			TriggerClientEvent('chatMessage', anyXPlayer.source, "FiveLife", {255, 0, 0}, "Vous avez teleporté par ^2" .. xPlayer.getName())
			TriggerClientEvent('chatMessage', xPlayer.source, "FiveLife", {255, 0, 0}, "Player ^2" .. anyXPlayer.getName() .. "^0 a été teleporté")
		end
	end
...
ESX.RegisterCommand('goto', 'mod', function(xPlayer, args, showError)
	...
	TriggerClientEvent('chatMessage', xPlayer.source, "FiveLife", {255, 0, 0}, "Téléporté au joueur ^2" .. args.playerId.getName() .. "")
...
ESX.RegisterCommand({'slayall', 'killall'}, 'superadmin', function(xPlayer, args, showError)
	for _,anyXPlayer in pairs(ESX.GetAllPlayers()) do
		if anyXPlayer ~= xPlayer then
			...
			TriggerClientEvent('chatMessage', xPlayer.source, "FiveLife", {255, 0, 0}, "Le joueur ^2" .. anyXPlayer.getName() .. "^0 a été tué.")
		end
	end
...
ESX.RegisterCommand('heal', 'mod', function(xPlayer, args, showError)
	...
	TriggerClientEvent('chatMessage', args.playerId.source, "FiveLife", {255, 0, 0}, "Vous avez été soigné par ^2" .. xPlayer.getName())
	TriggerClientEvent('chatMessage', xPlayer.source, "FiveLife", {255, 0, 0}, "Le joueur ^2" .. args.playerId.getName() .. "^0 a été soigné.")
...
ESX.RegisterCommand('freeze', 'mod', function(xPlayer, args, showError)
	...
	TriggerClientEvent('chatMessage', args.playerId.source, "FiveLife", {255, 0, 0}, "Vous avez été freeze par ^2" .. xPlayer.getName())
	TriggerClientEvent('chatMessage', xPlayer.source, "FiveLife", {255, 0, 0}, "Le joueur ^2" .. args.playerId.getName() .. "^0 a été freeze.")
...
ESX.RegisterCommand({'destroyvehicle'}, 'mod', function(xPlayer, args, showError)
	...
	TriggerClientEvent('chatMessage', xPlayer.source, "FiveLife", {255, 0, 0}, "Le joueur ^2" .. args.playerId.getName() .. "^0 a maintenant un véhicule détruit")
...
ESX.RegisterCommand({'setmodel', 'playermodel'}, 'mod', function(xPlayer, args, showError)
	...
	TriggerClientEvent('chatMessage', args.playerId.source, "FiveLife", {255, 0, 0}, "Votre modèle à changer grâce à ^2" .. xPlayer.getName())
	TriggerClientEvent('chatMessage', xPlayer.source, "FiveLife", {255, 0, 0}, "Le joueur ^2" .. args.playerId.getName() .. "^0 a changer de modèle")
end, true, {help = 'Défini le modèle d\'un joueur', validate = true, arguments = {
	{name = 'playerId', help = _U('commandgeneric_playerid'), type = 'player'},
...
ESX.RegisterCommand('setped', 'mod', function(xPlayer, args, showError)
	...
	TriggerClientEvent('chatMessage', xPlayer.source, "FiveLife", {255, 0, 0}, "Votre modèle a changé grâce à ^2" .. xPlayer.getName())
...
ESX.RegisterCommand('healall', 'superadmin', function(xPlayer, args, showError)
	for _,anyXPlayer in pairs(ESX.GetAllPlayers()) do
		if anyXPlayer ~= xPlayer then
			...
			TriggerClientEvent('chatMessage', anyXPlayer.source, "FiveLife", {255, 0, 0}, "Vous avez été soigné par ^2" .. xPlayer.getName())
			TriggerClientEvent('chatMessage', xPlayer.source, "FiveLife", {255, 0, 0}, "Le joueur ^2" .. anyXPlayer.getName() .. "^0 a été soigné.")
		end
	end
...
AddEventHandler('es_extended:displayReports', function(displayReports)
	if displayReports then
		TriggerClientEvent('chatMessage', source, "FiveLife", {255, 0, 0}, "Les reports sont actuellement affichés")
		hideReports[source] = false
	else
		TriggerClientEvent('chatMessage', source, "FiveLife", {255, 0, 0}, "Les reports sont actuellement cachés")
